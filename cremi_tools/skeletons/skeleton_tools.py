...
def convert_swc_to_volume(swc_file, shape, resolution, dtype='bool', invert_coordinates=False):
...
def paint_in_swc(swc_file, shape, resolution, invert_coordinates=False):
